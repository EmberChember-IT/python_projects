...
def play(word):
    ...
    print('Введите догадку. Это может быть буква или целое слово.\nЕсли вы вводите букву, она проверяется на наличие в слове.\nЕсли же вы проверяете целое слово, то буквы не проверяются, а попытка тратиться.\nУдачи)')

    
    while tries >= 0 :
        print(display_hangman(tries))
        print('Загаданное слово:', *word_completion)
        print('Написанные буквы:', *guessed_letters)
        print('Написанные слова:', *guessed_words)
        print('Количество попыток:', tries)
        s = input().upper()
        if s.isalpha():                 # Проверям наличие небукв
            if len(s) == 1:             # Проверяем букву
